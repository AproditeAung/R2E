...
@section('style')
    <style>
        @font-face{
            font-family: Billian;
            src : url("public/assets/fonts/Billian.ttf");
        }
...
{{--    //mobile view show items//--}}
    <div class="col-md-12 d-lg-none d-block ">
        ...
        <form action="{{ route('welcome') }}" method="get" class="d-flex align-items-center box  ">
            ...
            <i class="icofont icofont-settings p-2 "></i>
        </form>
    </div>
{{--    //mobile view show items//--}}
    ...
    <div class="col-md-9 my-3  mb-md-5 pb-lg-5  ">
        @foreach($lastestNews as $blog)
                <a href="{{ route('guest.blog.detail',$blog->slug) }}" class="row align-items-center mb-3  text-decoration-none link-secondary  ">
                    ...
                    <div class="col-6 col-md-7 px-2 px-lg-4  px-md-3  d-flex flex-column justify-content-between align-items-center mt-2 mt-lg-4 "
                        ...
                        <div class="">
                            ...
                            <h6 class="font-weight-bolder  h5 my-2 my-lg-0 fw-bolder  "> {{ \Illuminate\Support\Str::words($blog->title,20) }}</h6>
                            ...
                            <p style="text-align: justify" class="mt-3 d-none d-lg-block ">
                                {{ \Illuminate\Support\Str::words( $blog->body,35)  }}
                            </p>
                        </div>
                    </div>
                </a>
