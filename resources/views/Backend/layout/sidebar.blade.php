    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <x-side-bar route="{{ route('category.index') }}" sidebarname="Create Category" icon="pe-7s-disk "  active="genre_index_active"/>
                ...
                <li class="app-sidebar__heading">Editor Manager</li>
                <x-side-bar route="{{ route('requestEditor.index') }}" sidebarname="Editor List" icon=" pe-7s-edit "  active="editor_index_active"/>
